...
client1 = OpenAI(base_url="http://localhost:1234/v1", api_key="llama-3.2-1b-instruct")  # html to json
model = r"hugging-quants/Llama-3.2-1B-Instruct-Q8_0-GGUF/llama-3.2-1b-instruct-q8_0.gguf"
